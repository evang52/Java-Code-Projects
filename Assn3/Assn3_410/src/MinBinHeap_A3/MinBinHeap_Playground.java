...
//    collection[7]=new EntryPair("h",17);
    EntryPair one = new EntryPair("a", 5);
    collection[0]=one;
    collection[1]= new EntryPair("c", 4);
    collection[2] =new EntryPair("e", 8);
    collection[3] =new EntryPair("t", 2);
    collection[4] =new EntryPair("b", 1);
    collection[5] =new EntryPair("z", 7);
    
//  System.out.println("Priority: "+mbh.getMin().priority +" name: "+ mbh.getMin().value );
    mbh.build(collection);
    //System.out.println("val: "+mbh.getMin().value + " pri: "+mbh.getMin().value);
